            ...
            <div class="col-lg-4 col-md-6">
                <div class="d-flex align-items-center mb-3">
                    <?php if (get_setting('site_logo')): ?>
                        <img src="<?= base_url('uploads/settings/' . get_setting('site_logo')) ?>" alt="<?= esc(get_setting('company_name', 'Ngân Gia Nguyễn')) ?>" style="max-height: 48px; width: auto;" class="me-2 bg-white p-1 rounded">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <span class="h5 mb-0 text-dark fw-bold">NGÂN GIA NGUYỄN</span>
                </div>
