...
class Gallery extends BaseController
{
    public function index(): string
    {
        ...
        $data = [
            'images'          => $images,
            'albums'          => $albums,
            'seo_title'       => 'Thư viện hình ảnh hoạt động - Ngân Gia Nguyễn',
            'seo_description' => 'Xem các hình ảnh thực tế phòng nghỉ khách sạn, công trình giao thông và hoạt động sản xuất kinh doanh của công ty Ngân Gia Nguyễn.',
