...
Develop a premium corporate website based on CodeIgniter 4.

The website should be designed from scratch while taking visual inspiration from the reference website.

The goal is NOT to reproduce the original website, but to create a unique implementation with a similar user experience, content hierarchy, interaction patterns and premium visual quality.

# Reference Website Analysis

Before writing any code, analyze the reference website and identify:
